...
Insert into TWGRMENU
 ...
 Insert into TWGRMENU
   (TWGRMENU_NAME, TWGRMENU_SEQUENCE, TWGRMENU_URL_TEXT, TWGRMENU_URL, TWGRMENU_URL_DESC, TWGRMENU_ENABLED, TWGRMENU_DB_LINK_IND, TWGRMENU_SUBMENU_IND, TWGRMENU_ACTIVITY_DATE, TWGRMENU_SOURCE_IND)
 Values
   ('bmenu.P_PBMainMnu', 1, 'Page Builder Home Page', '/banner-sspb-test-app/', 'Got to home page on xe self-service page builder application', 'Y', 'N', 'N', SYSDATE, 'B');
Insert into TWGRMENU
   (TWGRMENU_NAME, TWGRMENU_SEQUENCE, TWGRMENU_URL_TEXT, TWGRMENU_URL, TWGRMENU_URL_DESC, TWGRMENU_ENABLED, TWGRMENU_DB_LINK_IND, TWGRMENU_SUBMENU_IND, TWGRMENU_ACTIVITY_DATE, TWGRMENU_SOURCE_IND)
 Values
   ('bmenu.P_PBMainMnu', 2, 'Virtual Domain Composer', '/banner-sspb-test-app/virtualDomainComposer/loadVirtualDomain', 'Create and maintain virtual domains', 'Y', 'N', 'N', SYSDATE, 'B');
Insert into TWGRMENU
   (TWGRMENU_NAME, TWGRMENU_SEQUENCE, TWGRMENU_URL_TEXT, TWGRMENU_URL, TWGRMENU_URL_DESC, TWGRMENU_ENABLED, TWGRMENU_DB_LINK_IND, TWGRMENU_SUBMENU_IND, TWGRMENU_ACTIVITY_DATE, TWGRMENU_SOURCE_IND)
 Values
   ('bmenu.P_PBMainMnu', 3, 'Visual Page Composer', '/banner-sspb-test-app/visualPageModelComposer/loadComposerPage', 'Create and maintain virtual pages', 'Y', 'N', 'N', SYSDATE, 'B');
Insert into TWGRMENU
   (TWGRMENU_NAME, TWGRMENU_SEQUENCE, TWGRMENU_URL_TEXT, TWGRMENU_URL, TWGRMENU_URL_DESC, TWGRMENU_ENABLED, TWGRMENU_DB_LINK_IND, TWGRMENU_SUBMENU_IND, TWGRMENU_ACTIVITY_DATE, TWGRMENU_SOURCE_IND)
 Values
   ('bmenu.P_PBMainMnu', 4, 'CSS Stylesheet Manager', '/banner-sspb-test-app/cssManager/loadCssManagerPage', 'Create and maintain css stylesheets', 'Y', 'N', 'N', SYSDATE, 'B');
Insert into TWGRMENU
   (TWGRMENU_NAME, TWGRMENU_SEQUENCE, TWGRMENU_URL_TEXT, TWGRMENU_URL, TWGRMENU_URL_DESC, TWGRMENU_ENABLED, TWGRMENU_DB_LINK_IND, TWGRMENU_SUBMENU_IND, TWGRMENU_ACTIVITY_DATE, TWGRMENU_SOURCE_IND)
 Values
   ('bmenu.P_PBMainMnu', 5, 'Page Roles', '/banner-sspb-test-app/customPage/page/pbadm.PageRoles', 'Maintain access to virtual pages', 'Y', 'N', 'N', SYSDATE, 'B');
Insert into TWGRMENU
   (TWGRMENU_NAME, TWGRMENU_SEQUENCE, TWGRMENU_URL_TEXT, TWGRMENU_URL, TWGRMENU_URL_DESC, TWGRMENU_ENABLED, TWGRMENU_DB_LINK_IND, TWGRMENU_SUBMENU_IND, TWGRMENU_ACTIVITY_DATE, TWGRMENU_SOURCE_IND)
 Values
   ('bmenu.P_PBMainMnu', 6, 'Virtual Domain Roles', '/banner-sspb-test-app/customPage/page/pbadm.VirtualDomainRoles', 'Maintain access to virtual domains', 'Y', 'N', 'N', SYSDATE, 'B');
Insert into TWGRMENU
   (TWGRMENU_NAME, TWGRMENU_SEQUENCE, TWGRMENU_URL_TEXT, TWGRMENU_URL, TWGRMENU_URL_DESC, TWGRMENU_ENABLED, TWGRMENU_DB_LINK_IND, TWGRMENU_SUBMENU_IND, TWGRMENU_ACTIVITY_DATE, TWGRMENU_SOURCE_IND)
 Values
   ('bmenu.P_PBMainMnu', 7, 'Export Pages', '/banner-sspb-test-app/customPage/page/pbadm.ExportPages', 'Export virtual page metadata to a file', 'Y', 'N', 'N', SYSDATE, 'B');
Insert into TWGRMENU
   (TWGRMENU_NAME, TWGRMENU_SEQUENCE, TWGRMENU_URL_TEXT, TWGRMENU_URL, TWGRMENU_URL_DESC, TWGRMENU_ENABLED, TWGRMENU_DB_LINK_IND, TWGRMENU_SUBMENU_IND, TWGRMENU_ACTIVITY_DATE, TWGRMENU_SOURCE_IND)
 Values
   ('bmenu.P_PBMainMnu', 8, 'Export Virtual Domains', '/banner-sspb-test-app/customPage/page/pbadm.ExportVirtualDomains', 'Export virtual domain metadata to a file', 'Y', 'N', 'N', SYSDATE, 'B');
Insert into TWGRMENU
   (TWGRMENU_NAME, TWGRMENU_SEQUENCE, TWGRMENU_URL_TEXT, TWGRMENU_URL, TWGRMENU_URL_DESC, TWGRMENU_ENABLED, TWGRMENU_DB_LINK_IND, TWGRMENU_SUBMENU_IND, TWGRMENU_ACTIVITY_DATE, TWGRMENU_SOURCE_IND)
 Values
   ('bmenu.P_PBMainMnu', 9, 'Export CSS Stylesheet', '/banner-sspb-test-app/customPage/page/pbadm.ExportCss', 'Export CSS Stylesheet metadata to a file', 'Y', 'N', 'N', SYSDATE, 'B');
COMMIT;
