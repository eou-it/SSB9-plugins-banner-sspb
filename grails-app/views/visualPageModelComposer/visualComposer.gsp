...
<div id="content" ng-controller="VisualPageComposerController" class="customPage container-fluid" ng-form="pagemodelform">
    ...
    <div class="btn-section-2">
        ...
        <button id="pageRoleId" value="" ng-show="pageName && pageName != newPageName" ng-disabled="!allowModify" ng-click="showRolesPage(); saveAs=false;" class="secondary" ><g:message code="sspb.page.visualbuilder.roles.label" /></button>
