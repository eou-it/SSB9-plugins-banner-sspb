...
<div id="content" role="main" ng-controller="VisualPageComposerController" class="customPage container-fluid" ng-form="pagemodelform">
    ...
    <div class="btn-section">
        ...
        <select tabindex="0" id="constantName" class="popupSelectBox vpc-name-input pbPopupDataGrid:{'serviceNameType':'pages','id':'constantName'}" name="constantName" role="dialog" aria-labelledby="lookupMessage" aria-label="press enter button to select a list of options"
                ng-model="pageName"
    ...
    <div class="btn-section-2">
        ...
        <select tabindex="0" id="extendsPage" class="popupSelectBox vpc-name-input pbPopupDataGrid:{'serviceNameType':'pages','id':'extendsPage'}" name="extendsPage" role="dialog" aria-labelledby="lookupMessage" aria-label="press enter button to select a list of options"
